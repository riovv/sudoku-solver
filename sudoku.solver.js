(function (global) {
    ...
    */   
    ...
    sudoku.solve = function (gridDigits) {
        ...
        console.log(sudoku.solver.digits);
        // Try to assign digits from the grid.
        for (square in gridDigits) {
            if (sudoku.solver.digits.hasOwnProperty(square)) {
                digit = gridDigits[square];
                if (!sudoku.solver.assign(sudoku.solver.digits, square, digit)) {
                    return false
                }
            }
        }
